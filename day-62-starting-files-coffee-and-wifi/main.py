...
class CafeForm(FlaskForm):
    ...
    close_time = StringField('Closing Time e.g.', validators=[DataRequired()])
...
def add_cafe():
    ...
    # with   if form.validate_on_submit()
        with open("day-62-starting-files-coffee-and-wifi/cafe-data.csv", mode="a", encoding="utf-8", newline="") as file:
